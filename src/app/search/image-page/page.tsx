			...
			<div className='w-full max-[1200px]:justify-evenly max-[1000px]:center  max-[700px]:gap-3 mt-4 flex flex-wrap gap-8'>
				{isFetching && !searchResultImage.length ? (
					...
					searchResultImage.map((item, index) => (
						<div onClick={() => window.open(item.image.contextLink)} key={index} className='w-[280px] max-[420px]:w-[350px] max-[420px]:h-[400px]  max-[700px]:h-[350px] max-[700px]:w-[180px] cursor-pointer rounded-md activeImage h-[390px]'>
							<img
								src={`${
